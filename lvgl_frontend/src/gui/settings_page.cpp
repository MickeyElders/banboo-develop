...
void Settings_page::create_footer_panel() {
    ...
    lv_label_set_text(start_label, LV_SYMBOL_PLAY " Start System");
    ...
    lv_label_set_text(emergency_label, LV_SYMBOL_WARNING " Emergency Stop");
    ...
    lv_label_set_text(power_label, LV_SYMBOL_POWER " Shutdown");
