...
void Settings_page::create_footer_panel() {
    ...
    lv_obj_set_style_text_font(start_label, &lv_font_noto_sans_cjk_14_minimal, 0);
    ...
    lv_obj_set_style_text_font(pause_label, &lv_font_noto_sans_cjk_14_minimal, 0);
    ...
    lv_obj_set_style_text_font(stop_label, &lv_font_noto_sans_cjk_14_minimal, 0);
    ...
    lv_obj_set_style_text_font(current_process_label_, &lv_font_noto_sans_cjk_14_minimal, 0);
    ...
    lv_obj_set_style_text_font(status_info_label_, &lv_font_noto_sans_cjk_14_minimal, 0);
    ...
    lv_obj_set_style_text_font(emergency_label, &lv_font_noto_sans_cjk_14_minimal, 0);
    ...
    lv_obj_set_style_text_font(power_label, &lv_font_noto_sans_cjk_14_minimal, 0);
