...
# Path to DeepStream WebRTC binary; default to /opt/bamboo-qt/bin/deepstream-webrtc-app unless overridden.
WEBRTC_BIN="${WEBRTC_BIN:-/opt/bamboo-qt/bin/deepstream-webrtc-app}"
